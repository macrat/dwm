...
static const char col_accent[]      = "#708090";
...
static const char *screenshotcmd[] = { "sh", "-c", "import $(date +'~/screenshot_%Y-%m-%dT%H:%M:%S.png')", NULL };
...
static Key keys[] = {
	...
	TILEKEYS(MODKEY,                                           1, 1, 1)
	TILEKEYS(MODKEY|ShiftMask,                                 1, 0, 0)
	TILEKEYS(MODKEY|ControlMask,                               0, 1, 0)
	TILEKEYS(MODKEY|ShiftMask|ControlMask,                     0, 0, 1)
	{ MODKEY|ShiftMask,             XK_t,      setdirs,        {.v = (int[]){ DirHor, DirVer, DirVer } } },
	{ MODKEY|ControlMask,           XK_t,      setdirs,        {.v = (int[]){ DirRotVer, DirHor, DirHor } } },
